...
hi_void pq_hihdr_v2_setimcmpos(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_cm_pos)
{
    ...
    db_imap_ctrl.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_ctrl.u32) + offset));
    db_imap_ctrl.bits.im_cm_pos = im_cm_pos;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_ctrl.u32) + offset), db_imap_ctrl.u32);
...
hi_void pq_hihdr_v2_setimapeotfparamrangemin(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 para)
{
    u_db_imap_in_rangemin para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_in_rangemin.u32) + offset));
    para_temp.bits.imap_eotfparam_range_min = para;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_in_rangemin.u32) + offset), para_temp.u32);

    return;
}

hi_void pq_hihdr_v2_setimapeotfparamrange(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 para)
{
    u_db_imap_in_range db_imap_in_range;

    db_imap_in_range.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_in_range.u32) + offset));
    db_imap_in_range.bits.imap_eotfparam_range = para;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_in_range.u32) + offset), db_imap_in_range.u32);

    return;
}

hi_void pq_hihdr_v2_setimapeotfparamrangeinv(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 para)
{
    u_db_imap_in_rangeinv db_imap_in_rangeinv;

    db_imap_in_rangeinv.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_in_rangeinv.u32) + offset));
    db_imap_in_rangeinv.bits.imap_eotfparam_range_inv = para;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_in_rangeinv.u32) + offset), db_imap_in_rangeinv.u32);
...
hi_void pq_hihdr_v2_setimapv3iptoff0(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_v3ipt_off_0)
{
    ...
    db_imap_iptoff0.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_iptoff0.u32) + offset));
    db_imap_iptoff0.bits.imap_v3ipt_off_0 = imap_v3ipt_off_0;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_iptoff0.u32) + offset), db_imap_iptoff0.u32);
...
hi_void pq_hihdr_v2_setimapv3iptoff1(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_v3ipt_off_1)
{
    ...
    db_imap_iptoff1.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_iptoff1.u32) + offset));
    db_imap_iptoff1.bits.imap_v3ipt_off_1 = imap_v3ipt_off_1;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_iptoff1.u32) + offset), db_imap_iptoff1.u32);
...
hi_void pq_hihdr_v2_setimapv3iptoff2(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_v3ipt_off_2)
{
    ...
    db_imap_iptoff2.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_iptoff2.u32) + offset));
    db_imap_iptoff2.bits.imap_v3ipt_off_2 = imap_v3ipt_off_2;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_iptoff2.u32) + offset), db_imap_iptoff2.u32);
...
hi_void pq_hihdr_v2_setimapiptscale(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_ipt_scale)
{
    ...
    db_imap_iptscale.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_iptscale.u32) + offset));
    db_imap_iptscale.bits.imap_ipt_scale = imap_ipt_scale;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_iptscale.u32) + offset), db_imap_iptscale.u32);
...
hi_void pq_hihdr_v2_setdegammarden(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 degamma_rd_en)
{
    ...
    db_imap_para_ren.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_para_ren.u32) + offset));
    db_imap_para_ren.bits.degamma_rd_en = degamma_rd_en;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_para_ren.u32) + offset), db_imap_para_ren.u32);
...
hi_void pq_hihdr_v2_setvdmparadata(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 vdm_para_data)
{
    ...
    db_imap_para_data.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_para_data.u32) + offset));
    db_imap_para_data.bits.vdm_para_data = vdm_para_data;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_para_data.u32) + offset), db_imap_para_data.u32);
...
hi_void pq_hihdr_v2_setvdmcoef1upd(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 vdm_coef1_upd)
{
    ...
    db_imap_para_up.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_para_up.u32) + offset));
    db_imap_para_up.bits.vdm_coef1_upd = vdm_coef1_upd;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_para_up.u32) + offset), db_imap_para_up.u32);
...
hi_void pq_hihdr_v2_setimdegammaclipmax(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 para)
{
    u_db_imap_degamma_clip_max para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_degamma_clip_max.u32) + offset));
    para_temp.bits.im_degamma_clip_max = para;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_degamma_clip_max.u32) + offset), para_temp.u32);
...
{
    u_db_imap_degamma_clip_min para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_degamma_clip_min.u32) + offset));
    para_temp.bits.im_degamma_clip_min = im_degamma_clip_min;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_degamma_clip_min.u32) + offset), para_temp.u32);

    return;
}

hi_void pq_hihdr_v2_setimapladjchromaweight(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 para)
{
    u_db_imap_ladj_weight db_imap_ladj_weight;

    db_imap_ladj_weight.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_ladj_weight.u32) + offset));
    db_imap_ladj_weight.bits.imap_ladj_chroma_weight = para;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_ladj_weight.u32) + offset), db_imap_ladj_weight.u32);
...
hi_void pq_hihdr_v2_setimv1hdren(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_v1_hdr_en)
{
    ...
    db_imap_yuv2rgb_ctrl.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_ctrl.u32) + offset));
    db_imap_yuv2rgb_ctrl.bits.im_v1_hdr_en = im_v1_hdr_en;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_ctrl.u32) + offset), db_imap_yuv2rgb_ctrl.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb00(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb_00)
{
    ...
    db_imap_yuv2rgb_coef00.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef00.u32) + offset));
    db_imap_yuv2rgb_coef00.bits.imap_m33yuv2rgb_00 = imap_m33yuv2rgb_00;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef00.u32) + offset), db_imap_yuv2rgb_coef00.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb01(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb_01)
{
    ...
    db_imap_yuv2rgb_coef01.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef01.u32) + offset));
    db_imap_yuv2rgb_coef01.bits.imap_m33yuv2rgb_01 = imap_m33yuv2rgb_01;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef01.u32) + offset), db_imap_yuv2rgb_coef01.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb02(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb_02)
{
    ...
    db_imap_yuv2rgb_coef02.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef02.u32) + offset));
    db_imap_yuv2rgb_coef02.bits.imap_m33yuv2rgb_02 = imap_m33yuv2rgb_02;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef02.u32) + offset), db_imap_yuv2rgb_coef02.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb10(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb_10)
{
    ...
    db_imap_yuv2rgb_coef03.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef03.u32) + offset));
    db_imap_yuv2rgb_coef03.bits.imap_m33yuv2rgb_10 = imap_m33yuv2rgb_10;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef03.u32) + offset), db_imap_yuv2rgb_coef03.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb11(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb_11)
{
    ...
    db_imap_yuv2rgb_coef04.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef04.u32) + offset));
    db_imap_yuv2rgb_coef04.bits.imap_m33yuv2rgb_11 = imap_m33yuv2rgb_11;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef04.u32) + offset), db_imap_yuv2rgb_coef04.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb12(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb_12)
{
    ...
    db_imap_yuv2rgb_coef05.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef05.u32) + offset));
    db_imap_yuv2rgb_coef05.bits.imap_m33yuv2rgb_12 = imap_m33yuv2rgb_12;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef05.u32) + offset), db_imap_yuv2rgb_coef05.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb20(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb_20)
{
    ...
    db_imap_yuv2rgb_coef06.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef06.u32) + offset));
    db_imap_yuv2rgb_coef06.bits.imap_m33yuv2rgb_20 = imap_m33yuv2rgb_20;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef06.u32) + offset), db_imap_yuv2rgb_coef06.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb21(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb_21)
{
    ...
    db_imap_yuv2rgb_coef07.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef07.u32) + offset));
    db_imap_yuv2rgb_coef07.bits.imap_m33yuv2rgb_21 = imap_m33yuv2rgb_21;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef07.u32) + offset), db_imap_yuv2rgb_coef07.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb22(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb_22)
{
    ...
    db_imap_yuv2rgb_coef08.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef08.u32) + offset));
    db_imap_yuv2rgb_coef08.bits.imap_m33yuv2rgb_22 = imap_m33yuv2rgb_22;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef08.u32) + offset), db_imap_yuv2rgb_coef08.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb200(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb2_00)
{
    ...
    db_imap_yuv2rgb_coef10.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef10.u32) + offset));
    db_imap_yuv2rgb_coef10.bits.imap_m33yuv2rgb2_00 = imap_m33yuv2rgb2_00;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef10.u32) + offset), db_imap_yuv2rgb_coef10.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb201(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb2_01)
{
    ...
    db_imap_yuv2rgb_coef11.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef11.u32) + offset));
    db_imap_yuv2rgb_coef11.bits.imap_m33yuv2rgb2_01 = imap_m33yuv2rgb2_01;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef11.u32) + offset), db_imap_yuv2rgb_coef11.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb202(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb2_02)
{
    ...
    db_imap_yuv2rgb_coef12.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef12.u32) + offset));
    db_imap_yuv2rgb_coef12.bits.imap_m33yuv2rgb2_02 = imap_m33yuv2rgb2_02;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef12.u32) + offset), db_imap_yuv2rgb_coef12.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb210(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb2_10)
{
    ...
    db_imap_yuv2rgb_coef13.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef13.u32) + offset));
    db_imap_yuv2rgb_coef13.bits.imap_m33yuv2rgb2_10 = imap_m33yuv2rgb2_10;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef13.u32) + offset), db_imap_yuv2rgb_coef13.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb211(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb2_11)
{
    ...
    db_imap_yuv2rgb_coef14.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef14.u32) + offset));
    db_imap_yuv2rgb_coef14.bits.imap_m33yuv2rgb2_11 = imap_m33yuv2rgb2_11;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef14.u32) + offset), db_imap_yuv2rgb_coef14.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb212(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb2_12)
{
    ...
    db_imap_yuv2rgb_coef15.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef15.u32) + offset));
    db_imap_yuv2rgb_coef15.bits.imap_m33yuv2rgb2_12 = imap_m33yuv2rgb2_12;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef15.u32) + offset), db_imap_yuv2rgb_coef15.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb220(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb2_20)
{
    ...
    db_imap_yuv2rgb_coef16.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef16.u32) + offset));
    db_imap_yuv2rgb_coef16.bits.imap_m33yuv2rgb2_20 = imap_m33yuv2rgb2_20;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef16.u32) + offset), db_imap_yuv2rgb_coef16.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb221(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb2_21)
{
    ...
    db_imap_yuv2rgb_coef17.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef17.u32) + offset));
    db_imap_yuv2rgb_coef17.bits.imap_m33yuv2rgb2_21 = imap_m33yuv2rgb2_21;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef17.u32) + offset), db_imap_yuv2rgb_coef17.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgb222(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb2_22)
{
    ...
    db_imap_yuv2rgb_coef18.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef18.u32) + offset));
    db_imap_yuv2rgb_coef18.bits.imap_m33yuv2rgb2_22 = imap_m33yuv2rgb2_22;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_coef18.u32) + offset), db_imap_yuv2rgb_coef18.u32);
...
hi_void pq_hihdr_v2_setimapm33yuv2rgbscale2p(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33yuv2rgb_scale2p)
{
    ...
    db_imap_yuv2rgb_scale2p.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_scale2p.u32) + offset));
    db_imap_yuv2rgb_scale2p.bits.imap_m33yuv2rgb_scale2p = imap_m33yuv2rgb_scale2p;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_scale2p.u32) + offset), db_imap_yuv2rgb_scale2p.u32);
...
hi_void pq_hihdr_v2_setimv3yuv2rgbdcin0(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_v3_yuv2rgb_dc_in_0)
{
    ...
    db_imap_yuv2rgb_in_dc00.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_in_dc00.u32) + offset));
    db_imap_yuv2rgb_in_dc00.bits.im_v3_yuv2rgb_dc_in_0 = im_v3_yuv2rgb_dc_in_0;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_in_dc00.u32) + offset), db_imap_yuv2rgb_in_dc00.u32);
...
hi_void pq_hihdr_v2_setimv3yuv2rgbdcin1(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_v3_yuv2rgb_dc_in_1)
{
    ...
    db_imap_yuv2rgb_in_dc01.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_in_dc01.u32) + offset));
    db_imap_yuv2rgb_in_dc01.bits.im_v3_yuv2rgb_dc_in_1 = im_v3_yuv2rgb_dc_in_1;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_in_dc01.u32) + offset), db_imap_yuv2rgb_in_dc01.u32);
...
hi_void pq_hihdr_v2_setimv3yuv2rgbdcin2(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_v3_yuv2rgb_dc_in_2)
{
    ...
    db_imap_yuv2rgb_in_dc02.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_in_dc02.u32) + offset));
    db_imap_yuv2rgb_in_dc02.bits.im_v3_yuv2rgb_dc_in_2 = im_v3_yuv2rgb_dc_in_2;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_in_dc02.u32) + offset), db_imap_yuv2rgb_in_dc02.u32);

    return;
}

hi_void pq_hihdr_v2_setimapv3yuv2rgboffinrgb0(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 para)
{
    u_db_imap_yuv2rgb_out_dc00 para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_out_dc00.u32) + offset));
    para_temp.bits.imap_v3yuv2rgb_offinrgb_0 = para;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_out_dc00.u32) + offset), para_temp.u32);

    return;
}

hi_void pq_hihdr_v2_setimapv3yuv2rgboffinrgb1(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 para)
{
    u_db_imap_yuv2rgb_out_dc01 para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_out_dc01.u32) + offset));
    para_temp.bits.imap_v3yuv2rgb_offinrgb_1 = para;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_out_dc01.u32) + offset), para_temp.u32);

    return;
}

hi_void pq_hihdr_v2_setimapv3yuv2rgboffinrgb2(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 para)
{
    u_db_imap_yuv2rgb_out_dc02 para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_out_dc02.u32) + offset));
    para_temp.bits.imap_v3yuv2rgb_offinrgb_2 = para;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_out_dc02.u32) + offset), para_temp.u32);

    return;
}

hi_void pq_hihdr_v2_setimv3yuv2rgb2dcin0(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 para)
{
    u_db_imap_yuv2rgb_in_dc10 db_imap_yuv2rgb_in_dc10;

    db_imap_yuv2rgb_in_dc10.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_in_dc10.u32) + offset));
    db_imap_yuv2rgb_in_dc10.bits.im_v3_yuv2rgb2_dc_in_0 = para;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_in_dc10.u32) + offset), db_imap_yuv2rgb_in_dc10.u32);

    return;
}

hi_void pq_hihdr_v2_setimv3yuv2rgb2dcin1(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 para)
{
    u_db_imap_yuv2rgb_in_dc11 db_imap_yuv2rgb_in_dc11;

    db_imap_yuv2rgb_in_dc11.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_in_dc11.u32) + offset));
    db_imap_yuv2rgb_in_dc11.bits.im_v3_yuv2rgb2_dc_in_1 = para;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_in_dc11.u32) + offset), db_imap_yuv2rgb_in_dc11.u32);

    return;
}

hi_void pq_hihdr_v2_setimv3yuv2rgb2dcin2(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 para)
{
    u_db_imap_yuv2rgb_in_dc12 db_imap_yuv2rgb_in_dc12;

    db_imap_yuv2rgb_in_dc12.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_in_dc12.u32) + offset));
    db_imap_yuv2rgb_in_dc12.bits.im_v3_yuv2rgb2_dc_in_2 = para;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_in_dc12.u32) + offset), db_imap_yuv2rgb_in_dc12.u32);
...
{
    u_db_imap_yuv2rgb_out_dc10 para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_out_dc10.u32) + offset));
    para_temp.bits.imap_v3yuv2rgb2_offinrgb_0 = data;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_out_dc10.u32) + offset), para_temp.u32);
...
{
    u_db_imap_yuv2rgb_out_dc11 para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_out_dc11.u32) + offset));
    para_temp.bits.imap_v3yuv2rgb2_offinrgb_1 = data;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_out_dc11.u32) + offset), para_temp.u32);
...
{
    u_db_imap_yuv2rgb_out_dc12 para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_out_dc12.u32) + offset));
    para_temp.bits.imap_v3yuv2rgb2_offinrgb_2 = data;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_out_dc12.u32) + offset), para_temp.u32);
...
hi_void pq_hihdr_v2_setimyuv2rgbclipmin(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_yuv2rgb_clip_min)
{
    ...
    db_imap_yuv2rgb_min.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_min.u32) + offset));
    db_imap_yuv2rgb_min.bits.im_yuv2rgb_clip_min = im_yuv2rgb_clip_min;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_min.u32) + offset), db_imap_yuv2rgb_min.u32);
...
hi_void pq_hihdr_v2_setimyuv2rgbclipmax(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_yuv2rgb_clip_max)
{
    ...
    db_imap_yuv2rgb_max.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_max.u32) + offset));
    db_imap_yuv2rgb_max.bits.im_yuv2rgb_clip_max = im_yuv2rgb_clip_max;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_max.u32) + offset), db_imap_yuv2rgb_max.u32);
...
hi_void pq_hihdr_v2_setimyuv2rgbthrr(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_yuv2rgb_thr_r)
{
    ...
    db_imap_yuv2rgb_thr.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_thr.u32) + offset));
    db_imap_yuv2rgb_thr.bits.im_yuv2rgb_thr_r = im_yuv2rgb_thr_r;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_yuv2rgb_thr.u32) + offset), db_imap_yuv2rgb_thr.u32);
...
hi_void pq_hihdr_v2_setimrgb2lmsen(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_rgb2lms_en)
{
    ...
    db_imap_rgb2lms_ctrl.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_ctrl.u32) + offset));
    db_imap_rgb2lms_ctrl.bits.im_rgb2lms_en = im_rgb2lms_en;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_ctrl.u32) + offset), db_imap_rgb2lms_ctrl.u32);
...
hi_void pq_hihdr_v2_setimapm33rgb2lms00(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33rgb2lms_00)
{
    ...
    db_imap_rgb2lms_coef0.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef0.u32) + offset));
    db_imap_rgb2lms_coef0.bits.imap_m33rgb2lms_00 = imap_m33rgb2lms_00;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef0.u32) + offset), db_imap_rgb2lms_coef0.u32);
...
hi_void pq_hihdr_v2_setimapm33rgb2lms01(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33rgb2lms_01)
{
    ...
    db_imap_rgb2lms_coef1.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef1.u32) + offset));
    db_imap_rgb2lms_coef1.bits.imap_m33rgb2lms_01 = imap_m33rgb2lms_01;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef1.u32) + offset), db_imap_rgb2lms_coef1.u32);
...
hi_void pq_hihdr_v2_setimapm33rgb2lms02(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33rgb2lms_02)
{
    ...
    db_imap_rgb2lms_coef2.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef2.u32) + offset));
    db_imap_rgb2lms_coef2.bits.imap_m33rgb2lms_02 = imap_m33rgb2lms_02;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef2.u32) + offset), db_imap_rgb2lms_coef2.u32);
...
hi_void pq_hihdr_v2_setimapm33rgb2lms10(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33rgb2lms_10)
{
    ...
    db_imap_rgb2lms_coef3.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef3.u32) + offset));
    db_imap_rgb2lms_coef3.bits.imap_m33rgb2lms_10 = imap_m33rgb2lms_10;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef3.u32) + offset), db_imap_rgb2lms_coef3.u32);
...
hi_void pq_hihdr_v2_setimapm33rgb2lms11(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33rgb2lms_11)
{
    ...
    db_imap_rgb2lms_coef4.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef4.u32) + offset));
    db_imap_rgb2lms_coef4.bits.imap_m33rgb2lms_11 = imap_m33rgb2lms_11;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef4.u32) + offset), db_imap_rgb2lms_coef4.u32);
...
hi_void pq_hihdr_v2_setimapm33rgb2lms12(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33rgb2lms_12)
{
    ...
    db_imap_rgb2lms_coef5.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef5.u32) + offset));
    db_imap_rgb2lms_coef5.bits.imap_m33rgb2lms_12 = imap_m33rgb2lms_12;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef5.u32) + offset), db_imap_rgb2lms_coef5.u32);
...
hi_void pq_hihdr_v2_setimapm33rgb2lms20(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33rgb2lms_20)
{
    ...
    db_imap_rgb2lms_coef6.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef6.u32) + offset));
    db_imap_rgb2lms_coef6.bits.imap_m33rgb2lms_20 = imap_m33rgb2lms_20;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef6.u32) + offset), db_imap_rgb2lms_coef6.u32);
...
hi_void pq_hihdr_v2_setimapm33rgb2lms21(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33rgb2lms_21)
{
    ...
    db_imap_rgb2lms_coef7.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef7.u32) + offset));
    db_imap_rgb2lms_coef7.bits.imap_m33rgb2lms_21 = imap_m33rgb2lms_21;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef7.u32) + offset), db_imap_rgb2lms_coef7.u32);
...
hi_void pq_hihdr_v2_setimapm33rgb2lms22(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33rgb2lms_22)
{
    ...
    db_imap_rgb2lms_coef8.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef8.u32) + offset));
    db_imap_rgb2lms_coef8.bits.imap_m33rgb2lms_22 = imap_m33rgb2lms_22;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_coef8.u32) + offset), db_imap_rgb2lms_coef8.u32);
...
hi_void pq_hihdr_v2_setimapm33rgb2lmsscale2p(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33rgb2lms_scale2p)
{
    ...
    db_imap_rgb2lms_scale2p.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_scale2p.u32) + offset));
    db_imap_rgb2lms_scale2p.bits.imap_m33rgb2lms_scale2p = imap_m33rgb2lms_scale2p;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_scale2p.u32) + offset), db_imap_rgb2lms_scale2p.u32);
...
hi_void pq_hihdr_v2_setimrgb2lmsclipmin(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_rgb2lms_clip_min)
{
    ...
    db_imap_rgb2lms_min.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_min.u32) + offset));
    db_imap_rgb2lms_min.bits.im_rgb2lms_clip_min = im_rgb2lms_clip_min;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_min.u32) + offset), db_imap_rgb2lms_min.u32);
...
hi_void pq_hihdr_v2_setimrgb2lmsclipmax(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_rgb2lms_clip_max)
{
    ...
    db_imap_rgb2lms_max.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_max.u32) + offset));
    db_imap_rgb2lms_max.bits.im_rgb2lms_clip_max = im_rgb2lms_clip_max;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_max.u32) + offset), db_imap_rgb2lms_max.u32);
...
hi_void pq_hihdr_v2_setimv3rgb2lmsdcin0(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_v3_rgb2lms_dc_in_0)
{
    ...
    db_imap_rgb2lms_in_dc0.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_in_dc0.u32) + offset));
    db_imap_rgb2lms_in_dc0.bits.im_v3_rgb2lms_dc_in_0 = im_v3_rgb2lms_dc_in_0;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_in_dc0.u32) + offset), db_imap_rgb2lms_in_dc0.u32);
...
hi_void pq_hihdr_v2_setimv3rgb2lmsdcin1(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_v3_rgb2lms_dc_in_1)
{
    ...
    db_imap_rgb2lms_in_dc1.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_in_dc1.u32) + offset));
    db_imap_rgb2lms_in_dc1.bits.im_v3_rgb2lms_dc_in_1 = im_v3_rgb2lms_dc_in_1;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_in_dc1.u32) + offset), db_imap_rgb2lms_in_dc1.u32);
...
hi_void pq_hihdr_v2_setimv3rgb2lmsdcin2(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_v3_rgb2lms_dc_in_2)
{
    ...
    db_imap_rgb2lms_in_dc2.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_in_dc2.u32) + offset));
    db_imap_rgb2lms_in_dc2.bits.im_v3_rgb2lms_dc_in_2 = im_v3_rgb2lms_dc_in_2;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_rgb2lms_in_dc2.u32) + offset), db_imap_rgb2lms_in_dc2.u32);
...
hi_void pq_hihdr_v2_setimlms2ipten(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_lms2ipt_en)
{
    ...
    db_imap_lms2ipt_ctrl.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_ctrl.u32) + offset));
    db_imap_lms2ipt_ctrl.bits.im_lms2ipt_en = im_lms2ipt_en;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_ctrl.u32) + offset), db_imap_lms2ipt_ctrl.u32);
...
hi_void pq_hihdr_v2_setimapm33lms2ipt00(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33lms2ipt_00)
{
    ...
    db_imap_lms2ipt_coef0.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef0.u32) + offset));
    db_imap_lms2ipt_coef0.bits.imap_m33lms2ipt_00 = imap_m33lms2ipt_00;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef0.u32) + offset), db_imap_lms2ipt_coef0.u32);
...
hi_void pq_hihdr_v2_setimapm33lms2ipt01(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33lms2ipt_01)
{
    ...
    db_imap_lms2ipt_coef1.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef1.u32) + offset));
    db_imap_lms2ipt_coef1.bits.imap_m33lms2ipt_01 = imap_m33lms2ipt_01;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef1.u32) + offset), db_imap_lms2ipt_coef1.u32);
...
hi_void pq_hihdr_v2_setimapm33lms2ipt02(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33lms2ipt_02)
{
    ...
    db_imap_lms2ipt_coef2.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef2.u32) + offset));
    db_imap_lms2ipt_coef2.bits.imap_m33lms2ipt_02 = imap_m33lms2ipt_02;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef2.u32) + offset), db_imap_lms2ipt_coef2.u32);
...
hi_void pq_hihdr_v2_setimapm33lms2ipt10(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33lms2ipt_10)
{
    ...
    db_imap_lms2ipt_coef3.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef3.u32) + offset));
    db_imap_lms2ipt_coef3.bits.imap_m33lms2ipt_10 = imap_m33lms2ipt_10;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef3.u32) + offset), db_imap_lms2ipt_coef3.u32);
...
hi_void pq_hihdr_v2_setimapm33lms2ipt11(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33lms2ipt_11)
{
    ...
    db_imap_lms2ipt_coef4.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef4.u32) + offset));
    db_imap_lms2ipt_coef4.bits.imap_m33lms2ipt_11 = imap_m33lms2ipt_11;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef4.u32) + offset), db_imap_lms2ipt_coef4.u32);
...
hi_void pq_hihdr_v2_setimapm33lms2ipt12(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33lms2ipt_12)
{
    ...
    db_imap_lms2ipt_coef5.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef5.u32) + offset));
    db_imap_lms2ipt_coef5.bits.imap_m33lms2ipt_12 = imap_m33lms2ipt_12;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef5.u32) + offset), db_imap_lms2ipt_coef5.u32);
...
hi_void pq_hihdr_v2_setimapm33lms2ipt20(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33lms2ipt_20)
{
    ...
    db_imap_lms2ipt_coef6.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef6.u32) + offset));
    db_imap_lms2ipt_coef6.bits.imap_m33lms2ipt_20 = imap_m33lms2ipt_20;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef6.u32) + offset), db_imap_lms2ipt_coef6.u32);
...
hi_void pq_hihdr_v2_setimapm33lms2ipt21(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33lms2ipt_21)
{
    ...
    db_imap_lms2ipt_coef7.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef7.u32) + offset));
    db_imap_lms2ipt_coef7.bits.imap_m33lms2ipt_21 = imap_m33lms2ipt_21;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef7.u32) + offset), db_imap_lms2ipt_coef7.u32);
...
hi_void pq_hihdr_v2_setimapm33lms2ipt22(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33lms2ipt_22)
{
    ...
    db_imap_lms2ipt_coef8.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef8.u32) + offset));
    db_imap_lms2ipt_coef8.bits.imap_m33lms2ipt_22 = imap_m33lms2ipt_22;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_coef8.u32) + offset), db_imap_lms2ipt_coef8.u32);
...
hi_void pq_hihdr_v2_setimapm33lms2iptscale2p(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 imap_m33lms2ipt_scale2p)
{
    ...
    db_imap_lms2ipt_scale2p.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_scale2p.u32) + offset));
    db_imap_lms2ipt_scale2p.bits.imap_m33lms2ipt_scale2p = imap_m33lms2ipt_scale2p;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_scale2p.u32) + offset), db_imap_lms2ipt_scale2p.u32);
...
hi_void pq_hihdr_v2_setimlms2iptclipminy(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_lms2ipt_clip_min_y)
{
    ...
    db_imap_lms2ipt_min.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_min.u32) + offset));
    db_imap_lms2ipt_min.bits.im_lms2ipt_clip_min_y = im_lms2ipt_clip_min_y;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_min.u32) + offset), db_imap_lms2ipt_min.u32);
...
hi_void pq_hihdr_v2_setimlms2iptclipmaxy(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_lms2ipt_clip_max_y)
{
    ...
    db_imap_lms2ipt_max.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_max.u32) + offset));
    db_imap_lms2ipt_max.bits.im_lms2ipt_clip_max_y = im_lms2ipt_clip_max_y;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_max.u32) + offset), db_imap_lms2ipt_max.u32);
...
hi_void pq_hihdr_v2_setimv3lms2iptdcout0(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_v3_lms2ipt_dc_out_0)
{
    ...
    db_imap_lms2ipt_out_dc0.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_out_dc0.u32) + offset));
    db_imap_lms2ipt_out_dc0.bits.im_v3_lms2ipt_dc_out_0 = im_v3_lms2ipt_dc_out_0;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_out_dc0.u32) + offset), db_imap_lms2ipt_out_dc0.u32);
...
hi_void pq_hihdr_v2_setimv3lms2iptdcout1(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_v3_lms2ipt_dc_out_1)
{
    ...
    db_imap_lms2ipt_out_dc1.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_out_dc1.u32) + offset));
    db_imap_lms2ipt_out_dc1.bits.im_v3_lms2ipt_dc_out_1 = im_v3_lms2ipt_dc_out_1;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_out_dc1.u32) + offset), db_imap_lms2ipt_out_dc1.u32);
...
hi_void pq_hihdr_v2_setimv3lms2iptdcout2(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_v3_lms2ipt_dc_out_2)
{
    ...
    db_imap_lms2ipt_out_dc2.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_out_dc2.u32) + offset));
    db_imap_lms2ipt_out_dc2.bits.im_v3_lms2ipt_dc_out_2 = im_v3_lms2ipt_dc_out_2;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_out_dc2.u32) + offset), db_imap_lms2ipt_out_dc2.u32);
...
hi_void pq_hihdr_v2_setimv3lms2iptdcin0(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_v3_lms2ipt_dc_in_0)
{
    ...
    db_imap_lms2ipt_in_dc0.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_in_dc0.u32) + offset));
    db_imap_lms2ipt_in_dc0.bits.im_v3_lms2ipt_dc_in_0 = im_v3_lms2ipt_dc_in_0;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_in_dc0.u32) + offset), db_imap_lms2ipt_in_dc0.u32);
...
hi_void pq_hihdr_v2_setimv3lms2iptdcin1(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_v3_lms2ipt_dc_in_1)
{
    ...
    db_imap_lms2ipt_in_dc1.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_in_dc1.u32) + offset));
    db_imap_lms2ipt_in_dc1.bits.im_v3_lms2ipt_dc_in_1 = im_v3_lms2ipt_dc_in_1;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_in_dc1.u32) + offset), db_imap_lms2ipt_in_dc1.u32);
...
hi_void pq_hihdr_v2_setimv3lms2iptdcin2(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_v3_lms2ipt_dc_in_2)
{
    ...
    db_imap_lms2ipt_in_dc2.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_in_dc2.u32) + offset));
    db_imap_lms2ipt_in_dc2.bits.im_v3_lms2ipt_dc_in_2 = im_v3_lms2ipt_dc_in_2;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_lms2ipt_in_dc2.u32) + offset), db_imap_lms2ipt_in_dc2.u32);
...
hi_void pq_hihdr_v2_setimtmv1en(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_v1_en)
{
    ...
    db_imap_tmap_v1_ctrl.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_ctrl.u32) + offset));
    db_imap_tmap_v1_ctrl.bits.im_tm_v1_en = im_tm_v1_en;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_ctrl.u32) + offset), db_imap_tmap_v1_ctrl.u32);
...
hi_void pq_hihdr_v2_setvhdrtmaprden(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 vhdr_tmap_rd_en)
{
    ...
    db_imap_tmap_v1_ren.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_ren.u32) + offset));
    db_imap_tmap_v1_ren.bits.vhdr_tmap_rd_en = vhdr_tmap_rd_en;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_ren.u32) + offset), db_imap_tmap_v1_ren.u32);
...
hi_void pq_hihdr_v2_setvhdrtmapparadata(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 vhdr_tmap_para_data)
{
    ...
    db_imap_tmap_v1_data.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_data.u32) + offset));
    db_imap_tmap_v1_data.bits.vhdr_tmap_para_data = vhdr_tmap_para_data;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_data.u32) + offset), db_imap_tmap_v1_data.u32);

    return;
}

hi_void pq_hihdr_v2_setimtmscalemixalpha(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 para)
{
    u_db_imap_tmap_v1_mix_alpha para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_mix_alpha.u32) + offset));
    para_temp.bits.im_tm_scale_mix_alpha = para;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_mix_alpha.u32) + offset), para_temp.u32);
...
hi_void pq_hihdr_v2_setimtmmixalpha(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_mix_alpha)
{
    ...
    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_mix_alpha.u32) + offset));
    para_temp.bits.im_tm_mix_alpha = im_tm_mix_alpha;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_mix_alpha.u32) + offset), para_temp.u32);
...
hi_void pq_hihdr_v2_setimtmxstep3(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_x_step_3)
{
    ...
    db_imap_tmap_v1_step1.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_step1.u32) + offset));
    db_imap_tmap_v1_step1.bits.im_tm_x_step_3 = im_tm_x_step_3;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_step1.u32) + offset), db_imap_tmap_v1_step1.u32);
...
hi_void pq_hihdr_v2_setimtmxstep7(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_x_step_7)
{
    ...
    db_imap_tmap_v1_step2.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_step2.u32) + offset));
    db_imap_tmap_v1_step2.bits.im_tm_x_step_7 = im_tm_x_step_7;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_step2.u32) + offset), db_imap_tmap_v1_step2.u32);
...
hi_void pq_hihdr_v2_setimtmxpos0(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_x_pos_0)
{
    ...
    db_imap_tmap_v1_pos1.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_pos1.u32) + offset));
    db_imap_tmap_v1_pos1.bits.im_tm_x_pos_0 = im_tm_x_pos_0;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_pos1.u32) + offset), db_imap_tmap_v1_pos1.u32);
...
hi_void pq_hihdr_v2_setimtmxpos1(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_x_pos_1)
{
    ...
    db_imap_tmap_v1_pos2.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_pos2.u32) + offset));
    db_imap_tmap_v1_pos2.bits.im_tm_x_pos_1 = im_tm_x_pos_1;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_pos2.u32) + offset), db_imap_tmap_v1_pos2.u32);
...
hi_void pq_hihdr_v2_setimtmxpos2(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_x_pos_2)
{
    ...
    db_imap_tmap_v1_pos3.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_pos3.u32) + offset));
    db_imap_tmap_v1_pos3.bits.im_tm_x_pos_2 = im_tm_x_pos_2;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_pos3.u32) + offset), db_imap_tmap_v1_pos3.u32);
...
hi_void pq_hihdr_v2_setimtmxpos3(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_x_pos_3)
{
    ...
    db_imap_tmap_v1_pos4.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_pos4.u32) + offset));
    db_imap_tmap_v1_pos4.bits.im_tm_x_pos_3 = im_tm_x_pos_3;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_pos4.u32) + offset), db_imap_tmap_v1_pos4.u32);
...
hi_void pq_hihdr_v2_setimtmxpos4(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_x_pos_4)
{
    ...
    db_imap_tmap_v1_pos5.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_pos5.u32) + offset));
    db_imap_tmap_v1_pos5.bits.im_tm_x_pos_4 = im_tm_x_pos_4;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_pos5.u32) + offset), db_imap_tmap_v1_pos5.u32);
...
hi_void pq_hihdr_v2_setimtmxpos5(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_x_pos_5)
{
    ...
    db_imap_tmap_v1_pos6.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_pos6.u32) + offset));
    db_imap_tmap_v1_pos6.bits.im_tm_x_pos_5 = im_tm_x_pos_5;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_pos6.u32) + offset), db_imap_tmap_v1_pos6.u32);
...
hi_void pq_hihdr_v2_setimtmxpos6(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_x_pos_6)
{
    ...
    db_imap_tmap_v1_pos7.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_pos7.u32) + offset));
    db_imap_tmap_v1_pos7.bits.im_tm_x_pos_6 = im_tm_x_pos_6;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_pos7.u32) + offset), db_imap_tmap_v1_pos7.u32);
...
hi_void pq_hihdr_v2_setimtmxpos7(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_x_pos_7)
{
    ...
    db_imap_tmap_v1_pos8.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_pos8.u32) + offset));
    db_imap_tmap_v1_pos8.bits.im_tm_x_pos_7 = im_tm_x_pos_7;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_pos8.u32) + offset), db_imap_tmap_v1_pos8.u32);
...
hi_void pq_hihdr_v2_setimtmxnum3(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_x_num_3)
{
    ...
    db_imap_tmap_v1_num1.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_num1.u32) + offset));
    db_imap_tmap_v1_num1.bits.im_tm_x_num_3 = im_tm_x_num_3;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_num1.u32) + offset), db_imap_tmap_v1_num1.u32);
...
hi_void pq_hihdr_v2_setimtmxnum7(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_x_num_7)
{
    ...
    db_imap_tmap_v1_num2.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_num2.u32) + offset));
    db_imap_tmap_v1_num2.bits.im_tm_x_num_7 = im_tm_x_num_7;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_num2.u32) + offset), db_imap_tmap_v1_num2.u32);
...
{
    u_db_imap_tmap_v1_luma_coef0 para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_luma_coef0.u32) + offset));
    para_temp.bits.im_tm_m3_lum_cal_0 = im_tm_m3_lum_cal_0;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_luma_coef0.u32) + offset), para_temp.u32);
...
{
    u_db_imap_tmap_v1_luma_coef1 para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_luma_coef1.u32) + offset));
    para_temp.bits.im_tm_m3_lum_cal_1 = im_tm_m3_lum_cal_1;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_luma_coef1.u32) + offset), para_temp.u32);
...
{
    u_db_imap_tmap_v1_luma_coef2 para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_luma_coef2.u32) + offset));
    para_temp.bits.im_tm_m3_lum_cal_2 = im_tm_m3_lum_cal_2;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_luma_coef2.u32) + offset), para_temp.u32);
...
{
    u_db_imap_tmap_v1_luma_scale para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_luma_scale.u32) + offset));
    para_temp.bits.im_tm_scale_lum_cal = im_tm_scale_lum_cal;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_luma_scale.u32) + offset), para_temp.u32);
...
{
    u_db_imap_tmap_v1_coef_scale para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_coef_scale.u32) + offset));
    para_temp.bits.im_tm_scale_coef = im_tm_scale_coef;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_coef_scale.u32) + offset), para_temp.u32);
...
{
    u_db_imap_tmap_v1_out_clip_min para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_out_clip_min.u32) + offset));
    para_temp.bits.im_tm_clip_min = im_tm_clip_min;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_out_clip_min.u32) + offset), para_temp.u32);
...
{
    u_db_imap_tmap_v1_out_clip_max para_temp;

    para_temp.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_out_clip_max.u32) + offset));
    para_temp.bits.im_tm_clip_max = im_tm_clip_max;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_out_clip_max.u32) + offset), para_temp.u32);
...
hi_void pq_hihdr_v2_setimtmdcout0(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_dc_out_0)
{
    ...
    db_imap_tmap_v1_out_dc0.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_out_dc0.u32) + offset));
    db_imap_tmap_v1_out_dc0.bits.im_tm_dc_out_0 = im_tm_dc_out_0;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_out_dc0.u32) + offset), db_imap_tmap_v1_out_dc0.u32);
...
hi_void pq_hihdr_v2_setimtmdcout1(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_dc_out_1)
{
    ...
    db_imap_tmap_v1_out_dc1.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_out_dc1.u32) + offset));
    db_imap_tmap_v1_out_dc1.bits.im_tm_dc_out_1 = im_tm_dc_out_1;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_out_dc1.u32) + offset), db_imap_tmap_v1_out_dc1.u32);
...
hi_void pq_hihdr_v2_setimtmdcout2(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_tm_dc_out_2)
{
    ...
    db_imap_tmap_v1_out_dc2.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_out_dc2.u32) + offset));
    db_imap_tmap_v1_out_dc2.bits.im_tm_dc_out_2 = im_tm_dc_out_2;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_tmap_v1_out_dc2.u32) + offset), db_imap_tmap_v1_out_dc2.u32);
...
hi_void pq_hihdr_v2_setimcmdemopos(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_cm_demo_pos)
{
    ...
    db_imap_cacm_reg0.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_cacm_reg0.u32) + offset));
    db_imap_cacm_reg0.bits.im_cm_demo_pos = im_cm_demo_pos;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_cacm_reg0.u32) + offset), db_imap_cacm_reg0.u32);
...
hi_void pq_hihdr_v2_setimcmclutrden(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_cm_clut_rd_en)
{
    ...
    db_imap_cacm_reg1.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_cacm_reg1.u32) + offset));
    db_imap_cacm_reg1.bits.im_cm_clut_rd_en = im_cm_clut_rd_en;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_cacm_reg1.u32) + offset), db_imap_cacm_reg1.u32);
...
hi_void pq_hihdr_v2_setimcmclutrdatarg(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_cm_clut_rdata_rg)
{
    ...
    db_imap_cacm_reg2.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_cacm_reg2.u32) + offset));
    db_imap_cacm_reg2.bits.im_cm_clut_rdata_rg = im_cm_clut_rdata_rg;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_cacm_reg2.u32) + offset), db_imap_cacm_reg2.u32);
...
hi_void pq_hihdr_v2_setimcmclutrdatab(vdp_regs_type *vdp_reg, hi_u32 offset, hi_u32 im_cm_clut_rdata_b)
{
    ...
    db_imap_cacm_reg3.u32 = pq_new_regread((uintptr_t)(&(vdp_reg->db_imap_cacm_reg3.u32) + offset));
    db_imap_cacm_reg3.bits.im_cm_clut_rdata_b = im_cm_clut_rdata_b;
    pq_new_regwrite ((uintptr_t)(&(vdp_reg->db_imap_cacm_reg3.u32) + offset), db_imap_cacm_reg3.u32);
