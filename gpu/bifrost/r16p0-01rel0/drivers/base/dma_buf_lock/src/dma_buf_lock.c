 ...
 *
 * Allocates required memory, copies hi_dma_buf_fd list from userspace,
...
#if DMA_BUF_LOCK_DEBUG
		printk(KERN_DEBUG "dma_buf_lock_dolock : hi_dma_buf_fd %i dma_buf %p dma_fence reservation %p\n",
