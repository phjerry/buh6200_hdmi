...
#ifdef CONFIG_HIG1
struct tagged_addr { u64 tagged_addr; };
#else
 ...
 */
#ifdef CONFIG_HIG1
static inline u64 as_phys_addr_t(struct tagged_addr t)
#else
 ...
 */
#ifdef CONFIG_HIG1
static inline struct tagged_addr as_tagged(u64 phys)
#else
 ...
 */
#ifdef CONFIG_HIG1
static inline struct tagged_addr as_tagged_tag(u64 phys, int tag)
#else
