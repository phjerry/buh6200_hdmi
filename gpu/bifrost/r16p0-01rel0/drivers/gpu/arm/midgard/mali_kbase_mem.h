...
#ifdef CONFIG_HIG1
#define KBASE_REG_HFBC            (1ul << 26)

#define KBASE_REG_ZONE_HFBC_VA         	KBASE_REG_ZONE(3)
/* Starting after KBASE_REG_ZONE_CUSTOM_VA */
#define KBASE_REG_ZONE_HFBC_VA_BASE    	(0x7c0000000ULL >> PAGE_SHIFT)
#define KBASE_REG_ZONE_HFBC_VA_SIZE    	((1024ULL * 1024 * 1024) >> PAGE_SHIFT)
#else
#define KBASE_REG_ZONE_HFBC_VA_SIZE    	(0ULL)
#endif
...
#ifdef CONFIG_HIG1
#define KBASE_REG_ZONE_CUSTOM_VA_SIZE    (KBASE_REG_ZONE_HFBC_VA_BASE - KBASE_REG_ZONE_CUSTOM_VA_BASE)
#else
...
#ifdef CONFIG_HIG1
/**
 * kbase_hmmu_init - Initialise an object representing GPU page tables for HiG1
 *
 * The structure should be terminated using kbase_mmu_term()
 *
 * @kbdev: kbase device
...
/**
 * kbase_hmmu_term - Terminate an object representing GPU page tables for  HiG1
 *
 * This will free any page tables that have been allocated
 *
 * @kbdev: kbase device
...
#ifdef CONFIG_HIG1
/**
 * kbase_mmu_update_asid - Update the asid in the GMMU HiG1 pages
 *
 * The caller has the following locking conditions:
 * - It must hold kbase_device->mmu_hw_mutex
 * - It must hold the hwaccess_lock
