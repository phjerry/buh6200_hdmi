...
/**
 * struct kbase_ioctl_ice_descriptor_update - Update the ice descriptor
 * @valid: 0, invalidate the ice descriptor; 1, validate the ice decriptor
 * @desc: ice descriptor content
 */
struct kbase_ioctl_ice_descriptor_update {
       __u32 valid;
       __u32 secure;
       struct eglp_hiice_desc desc;
};

#define KBASE_IOCTL_ICE_DESCRIPTOR_UPDATE \
       _IOW(KBASE_IOCTL_TYPE, 36, struct kbase_ioctl_ice_descriptor_update)
