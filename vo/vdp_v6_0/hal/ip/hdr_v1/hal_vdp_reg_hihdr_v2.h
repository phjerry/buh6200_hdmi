...
#ifndef __HAL_VDP_REG_HIHDR_V2_H__
#define __HAL_VDP_REG_HIHDR_V2_H__
...
hi_void vdp_hdr_setvcvmomaprgb2yuvmin(vdp_regs_type *vdp_reg, hi_u32 v_omap_rgb2yuvmin);
hi_void vdp_hdr_setvcvmomaprgb2yuvmax(vdp_regs_type *vdp_reg, hi_u32 v_omap_rgb2yuvmax);
