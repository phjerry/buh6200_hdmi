 ...
 * Description: vicap coef param define
 * Author: sdk
 * Create: 2019-12-14
 */
...
#define COEFF_OFF_NUM 8

/* clang-format off */
/* ==1 */
static hi_s32 g_coef8_no_scale[COEFF_GRPNUM][COEFF_OFF_NUM] = {
    {0,   0,   0,    511,  0,    0,    0,   0},
    { -1,  3,   -12,  511,  14,   -4,   1,   0},
    { -2,  6,   -23,  509,  28,   -8,   2,   0},
...
/* >=0.75 or >=0.5 */
static hi_s32 g_coef8_2x_scale[COEFF_GRPNUM][COEFF_OFF_NUM] = {
...
/* >=0.33 */
static hi_s32 g_coef8_3x_scale[COEFF_GRPNUM][COEFF_OFF_NUM] = {
...
/* >=0.25 */
static hi_s32 g_coef8_4x_scale[COEFF_GRPNUM][COEFF_OFF_NUM] = {
...
/* else */
static hi_s32 g_coef8_other_scale[COEFF_GRPNUM][COEFF_OFF_NUM] = {
