...
static struct snd_soc_dai_link hiaiao_dai[] = {
    {
        ...
        .init = hisi_alsa_codec_init,  /* #ifdef HI_ALSA_TLV320_SUPPORT */
        .ops = &hisi_codec_ops,
    },
};
#else
