...
u32 glcoex_ver_date_8822b_1ant = 20180921;
u32 glcoex_ver_8822b_1ant = 0x69;
						  ...
						  u8 reason)
{
	...
	if (wifi_link_info_ext->is_all_under_5g || num_of_wifi_link == 0 ||
		...
		halbtc8822b1ant_limited_rx(btc, NM_EXCU, FALSE, FALSE, 64);
		...
		if (coex_sta->hid_exist || coex_sta->hid_pair_cnt > 0 ||
			...
			halbtc8822b1ant_limited_rx(btc, NM_EXCU, FALSE, FALSE,
						   64);
		}
	}
}
