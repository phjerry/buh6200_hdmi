...
#ifndef __HAL_HDMI_LINK_TRAINING_REG_H__
#define __HAL_HDMI_LINK_TRAINING_REG_H__

/* training_cfg module field info */
#define reg_flt_mcu_pram(s)   (0x20000 + 0x4 * (s))       /* FRL training MCU program space */
#define reg_flt_mcu_pram_f(x) (((x) & 0xffffffff) << 0) /* [31:0] */
#define REG_FLT_MCU_PRAM_M    (0xffffffff << 0)

#define reg_flt_mcu_dram(s)   (0x28000 + 0x4 * (s)) /* FRL training MCU data space */
#define reg_flt_mcu_dram_f(x) (((x) & 0xff) << 0) /* [7:0] */
#define REG_FLT_MCU_DRAM_M    (0xff << 0)

#define REG_FRL_TRN_START      0x29000 /* FRL configuration MCU training begins */
#define reg_frl_trn_start_f(x) (((x) & 0x1) << 0) /* [0] */
#define REG_FRL_TRN_START_M    (0x1 << 0)

#define REG_FRL_TRN_STOP      0x29004 /* FRL configuration MCU training stop */
#define reg_frl_trn_stop_f(x) (((x) & 0x1) << 0) /* [0] */
#define REG_FRL_TRN_STOP_M    (0x1 << 0)

#define REG_FRL_TRN_MODE      0x29008 /* FRL configuration training mode */
#define reg_frl_trn_mode_f(x) (((x) & 0x1) << 0) /* [0] */
#define REG_FRL_TRN_MODE_M    (0x1 << 0)

#define REG_FRL_MCU_UART_CTRL     0x2900C /* MCU UART control register */
...
#define REG_FRL_MCU_TRN_RD_BACK_EN 0x29010 /* MCU training readback Sink configuration enable */
#define reg_mcu_trn_rd_back_en(x)  (((x) & 0x1) << 0) /* [0] */
#define REG_MCU_TRN_RD_BACK_EN_M   (0x1 << 0)

#define REG_FRL_MCU_NO_TIMEOUT_EN 0x29014 /* MCU training is Polling enabled */
#define reg_mcu_trn_poll_en(x)    (((x) & 0x1) << 0) /* [0] */
#define REG_MCU_TRN_POLL_EN_M     (0x1 << 0)

#define REG_FRL_POLLING_TIMER_THD 0x29018 /* FRL training polling timer threshold configuration */
#define reg_frl_poll_timer_thd(x) (((x) & 0xffffff) << 0) /* [0] */
#define REG_FRL_POLL_TIMER_THD_M  (0xffffff << 0)

#define REG_FRL_POLLING_TIMER_START 0x2901C /* FRL training starts regularly */
#define reg_frl_poll_timer_start(x) (((x) & 0x1) << 0) /* [0] */
#define REG_FRL_POLL_TIMER_START_M  (0x1 << 0)

#define REG_FRL_TRN_INT_MASK                0x29020 /* FRL training interrupt mask enable */
...
#define REG_FRL_TRN_INT_RAW                0x29024 /* FRL Training Interrupt Status Register */
...
#define REG_FRL_TRN_LTP1     0x29048 /* FRL training Sink ln(2..3)_LTP_req value */
...
#define REG_SOURCE_FFE_UP0         0x2904C /* SOURCE lane0_lane1 FFE value update during training */
...
#define REG_SOURCE_FFE_UP1         0x29050 /* SOURCE lane2_lane3 FFE value update during training */
...
#define REG_FRL_MCU_TRN_STATUS      0x29054 /* MCU training status record */
#define reg_frl_mcu_trn_status_f(x) (((x) & 0xf) << 0) /* [3:0] */
#define REG_FRL_MCU_TRN_STATUS_M    (0xf << 0)

#define REG_FRL_MCU_TRN_FAIL_RES      0x29058 /* MCU training failure reason record */
#define reg_frl_mcu_trn_fail_res_f(x) (((x) & 0xf) << 0) /* [3:0] */
#define REG_FRL_MCU_TRN_FAIL_RES_M    (0xf << 0)

#define REG_FRL_MCU_EXINT_MASK          0x2905C /* MCU External interrupt mask enable */
...
#define REG_FRL_MCU_EXINT_RAW    0x29060 /* MCU External interrupt status */
