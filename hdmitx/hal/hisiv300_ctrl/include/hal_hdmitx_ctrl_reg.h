...
#ifndef __HAL_HDMI_CTRL_REG_H__
#define __HAL_HDMI_CTRL_REG_H__
...
#define REG_PWD_SLAVE_CFG       0x0044
...
#define REG_PWD_MST_STATE         0x0048
...
#define REG_DDC_MST_ARB_CTRL     0x0064
...
#define REG_DDC_MST_ARB_REQ 0x0068
#define reg_cpu_ddc_req(x)  (((x) & 1) << 0) /* [0] */
#define REG_CPU_DDC_REQ_M   (1 << 0)

#define REG_DDC_MST_ARB_ACK    0x006C
...
#define REG_VIDPATH_INTR_STATE     0x0114
#define reg_vidpath_intr_state6(x) (((x) & 1) << 6) /* [6] */
#define REG_VIDPATH_INTR_STATE6_M  (1 << 6)
#define reg_vidpath_intr_state5(x) (((x) & 1) << 5) /* [5] */
#define REG_VIDPATH_INTR_STATE5_M  (1 << 5)
#define reg_vidpath_intr_state4(x) (((x) & 1) << 4) /* [4] */
#define REG_VIDPATH_INTR_STATE4_M  (1 << 4)
#define reg_vidpath_intr_state3(x) (((x) & 1) << 3) /* [3] */
#define REG_VIDPATH_INTR_STATE3_M  (1 << 3)
#define reg_vidpath_intr_state2(x) (((x) & 1) << 2) /* [2] */
#define REG_VIDPATH_INTR_STATE2_M  (1 << 2)
#define reg_vidpath_intr_state1(x) (((x) & 1) << 1) /* [1] */
#define REG_VIDPATH_INTR_STATE1_M  (1 << 1)
#define reg_vidpath_intr_state0(x) (((x) & 1) << 0) /* [0] */
#define REG_VIDPATH_INTR_STATE0_M  (1 << 0)

#define REG_VIDPATH_INTR_MASK     0x0118
#define reg_vidpath_intr_mask6(x) (((x) & 1) << 6) /* [6] */
#define REG_VIDPATH_INTR_MASK6_M  (1 << 6)
#define reg_vidpath_intr_mask5(x) (((x) & 1) << 5) /* [5] */
#define REG_VIDPATH_INTR_MASK5_M  (1 << 5)
#define reg_vidpath_intr_mask4(x) (((x) & 1) << 4) /* [4] */
#define REG_VIDPATH_INTR_MASK4_M  (1 << 4)
#define reg_vidpath_intr_mask3(x) (((x) & 1) << 3) /* [3] */
#define REG_VIDPATH_INTR_MASK3_M  (1 << 3)
#define reg_vidpath_intr_mask2(x) (((x) & 1) << 2) /* [2] */
#define REG_VIDPATH_INTR_MASK2_M  (1 << 2)
#define reg_vidpath_intr_mask1(x) (((x) & 1) << 1) /* [1] */
#define REG_VIDPATH_INTR_MASK1_M  (1 << 1)
#define reg_vidpath_intr_mask0(x) (((x) & 1) << 0) /* [0] */
#define REG_VIDPATH_INTR_MASK0_M  (1 << 0)

#define REG_AUDPATH_INTR_STATE     0x011C
#define reg_audpath_intr_state8(x) (((x) & 1) << 8) /* [8] */
#define REG_AUDPATH_INTR_STATE8_M  (1 << 8)
#define reg_audpath_intr_state7(x) (((x) & 1) << 7) /* [7] */
#define REG_AUDPATH_INTR_STATE7_M  (1 << 7)
#define reg_audpath_intr_state6(x) (((x) & 1) << 6) /* [6] */
#define REG_AUDPATH_INTR_STATE6_M  (1 << 6)
#define reg_audpath_intr_state5(x) (((x) & 1) << 5) /* [5] */
#define REG_AUDPATH_INTR_STATE5_M  (1 << 5)
#define reg_audpath_intr_state4(x) (((x) & 1) << 4) /* [4] */
#define REG_AUDPATH_INTR_STATE4_M  (1 << 4)
#define reg_audpath_intr_state3(x) (((x) & 1) << 3) /* [3] */
#define REG_AUDPATH_INTR_STATE3_M  (1 << 3)
#define reg_audpath_intr_state2(x) (((x) & 1) << 2) /* [2] */
#define REG_AUDPATH_INTR_STATE2_M  (1 << 2)
#define reg_audpath_intr_state1(x) (((x) & 1) << 1) /* [1] */
#define REG_AUDPATH_INTR_STATE1_M  (1 << 1)
#define reg_audpath_intr_state0(x) (((x) & 1) << 0) /* [0] */
#define REG_AUDPATH_INTR_STATE0_M  (1 << 0)

#define REG_AUDPATH_INTR_MASK     0x0120
#define reg_audpath_intr_mask8(x) (((x) & 1) << 8) /* [8] */
#define REG_AUDPATH_INTR_MASK8_M  (1 << 8)
#define reg_audpath_intr_mask7(x) (((x) & 1) << 7) /* [7] */
#define REG_AUDPATH_INTR_MASK7_M  (1 << 7)
#define reg_audpath_intr_mask6(x) (((x) & 1) << 6) /* [6] */
#define REG_AUDPATH_INTR_MASK6_M  (1 << 6)
#define reg_audpath_intr_mask5(x) (((x) & 1) << 5) /* [5] */
#define REG_AUDPATH_INTR_MASK5_M  (1 << 5)
#define reg_audpath_intr_mask4(x) (((x) & 1) << 4) /* [4] */
#define REG_AUDPATH_INTR_MASK4_M  (1 << 4)
#define reg_audpath_intr_mask3(x) (((x) & 1) << 3) /* [3] */
#define REG_AUDPATH_INTR_MASK3_M  (1 << 3)
#define reg_audpath_intr_mask2(x) (((x) & 1) << 2) /* [2] */
#define REG_AUDPATH_INTR_MASK2_M  (1 << 2)
#define reg_audpath_intr_mask1(x) (((x) & 1) << 1) /* [1] */
#define REG_AUDPATH_INTR_MASK1_M  (1 << 1)
#define reg_audpath_intr_mask0(x) (((x) & 1) << 0) /* [0] */
#define REG_AUDPATH_INTR_MASK0_M  (1 << 0)
