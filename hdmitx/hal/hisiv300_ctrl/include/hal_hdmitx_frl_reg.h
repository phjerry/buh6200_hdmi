...
#ifndef __HAL_HDMITX_FRL_REG_H__
#define __HAL_HDMITX_FRL_REG_H__

/* tx_frl_cfg module field info */
#define REG_TX_FRL_VERSION     0x3000 /* FRL Logic Version Update Time Register. */
 ...
 */
#define REG_AV_MAX_LEN      0x3104
#define reg_av_max_len_f(x) (((x) & 0xffff) << 0) /* [15:0] */
#define REG_AV_MAX_LEN_F_M  (0xffff << 0)

#define REG_AV_GAP_LEN      0x3108 /* number of Gaps to be inserted between AV slices */
...
#define REG_EXTRA_MODE_EN      0x3138 /* Extra mode enable */
#define reg_extra_mode_en_f(x) (((x) & 0x1) << 0) /* [0] */
#define REG_EXTRA_MODE_EN_F_M  (0x1 << 0)

#define REG_SBC_INT_STATUS      0x3140 /* Interrupt status of the SBC module */
#define reg_sbc_int_status_f(x) (((x) & 0xf) << 0) /* [3:0] */
#define REG_SBC_INT_STATUS_F_M  (0xf << 0)

#define REG_VBLANK1_LINES      0x3144 /* VBLANK1 lines */
#define reg_vblank1_lines_f(x) (((x) & 0x3ff) << 0) /* [9:0] */
#define REG_VBLANK1_LINES_F_M  (0x3ff << 0)

#define REG_LINE_START_HSYNC_EN      0x3148 /* Reference Shift time Use line synchronization enable */
#define reg_line_start_hsync_en_f(x) (((x) & 0x1) << 0) /* [0] */
#define REG_LINE_START_HSYNC_EN_F_M  (0x1 << 0)

#define REG_EXTRA_NO_GAP_FLAG      0x3150 /* Special format does not require the insertion of the GAP package flag */
#define reg_extra_no_gap_flag_f(x) (((x) & 0x1) << 0) /* [0] */
#define REG_EXTRA_NO_GAP_FLAG_F_M  (0x1 << 0)

#define REG_RESERVED_REG0 0x3154 /* Keep DFX register 0 */
#define REG_RESERVED_REG1 0x3158 /* Keep DFX register 1 */
#define REG_RESERVED_REG2 0x315C /* Keep DFX register 2 */
#define REG_RESERVED_REG3 0x3160 /* Keep DFX register 3 */
#define REG_RESERVED_REG4 0x3164 /* Keep DFX register 4 */

#define reg_reserved_reg(x) (((x) & 0xffffffff) << 0) /* [31:0] */
#define REG_RESERVED_REG_M  (0xffffffff << 0)

#define REG_HTOTAL_ERR_INFO      0x3168 /* HTOTAL statistical error information register */
#define reg_htotal_err_info_f(x) (((x) & 0xffffffff) << 0) /* [31:0] */
#define REG_HTOTAL_ERR_INFO_F_M  (0xffffffff << 0)

#define REG_PP_STATUS      0x316C /* Tx_frl_pp module status register */
#define reg_pp_status_f(x) (((x) & 0xffffffff) << 0) /* [31:0] */
#define REG_PP_STATUS_F_M  (0xffffffff << 0)

#define REG_MANUAL_SB_GEN      0x3170 /* SB structure generation control */
#define reg_manual_sb_gen_f(x) (((x) & 0x3) << 0) /* [1:0] */
#define REG_MANUAL_SB_GEN_F_M  (0x3 << 0)

#define REG_IN_CRC0        0x3180 /* Input CRC0 */
#define reg_tx2apb_crc0(x) (((x) & 0xffffffff) << 0) /* [31:0] */
#define REG_TX2APB_CRC0_M  (0xffffffff << 0)

#define REG_IN_CRC1        0x3184 /* Input CRC1 */
#define reg_tx2apb_crc1(x) (((x) & 0xffffffff) << 0) /* [31:0] */
#define REG_TX2APB_CRC1_M  (0xffffffff << 0)

#define REG_PFIFO_BASE_THRESHOLD      0x31A0 /* Alternative flow control fifo base value */
#define reg_pfifo_base_threshold_f(x) (((x) & 0xffff) << 0) /* [15:0] */
#define REG_PFIFO_BASE_THRESHOLD_M    (0xffff << 0)

#define REG_PFIFO_LINE_THRESHOLD    0x31A4 /* Alternative flow control fifo waterline */
...
#define REG_LM_IN_AC0_CMD     0x3200 /* Indirect access to issue commands */
...
#define REG_LM_CODE_RFD        0x3204 /* RFD initial value */
...
#define REG_LM_IN_AC0_RDATA 0x3208 /* Indirect access returns read data */
#define reg_in_ac0_rdata(x) (((x) & 0xffffffff) << 0) /* [31:0] */
#define REG_IN_AC0_RDATA_M  (0xffffffff << 0)

#define REG_LM_IN_AC0_WDATA 0x320C /* Indirect access to write data */
#define reg_in_ac0_wdata(x) (((x) & 0xffffffff) << 0) /* [31:0] */
#define REG_IN_AC0_WDATA_M  (0xffffffff << 0)

#define REG_LM_SRC_EN        0x3210 /* Scrambling enable register */
...
#define REG_LM_SRC_INIT0        0x3214 /* Scrambling initial value register 0 */
...
#define REG_LM_SRC_INIT1        0x3218 /* Scrambling initial value register 1 */
...
#define REG_LM_COMMAND_EN 0x321C /* lm Register configuration enable */
#define reg_command_en(x) (((x) & 0xffff) << 0) /* [15:0] */
#define REG_COMMAND_EN_M  (0xffff << 0)

#define REG_RS_SPLIT_SB_CNT      0x3300 /* Non-complete super block count input by RS module */
#define reg_rs_split_sb_cnt_f(x) (((x) & 0xffffffff) << 0) /* [31:0] */
#define REG_RS_SPLIT_SB_CNT_F_M  (0xffffffff << 0)

#define REG_FRL_CLK_DET_STABLE 0x3500 /* Frl clock detection status */
